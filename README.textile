...
Before you can compile the module, you must save @sys_call_table.template.h@ as @sys_call_table.h@ ad set @SYS_CALL_TABLE@ to the correct value. Now type @make@.
