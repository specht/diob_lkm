...
* watched: The transition from unwatched to watched happens on @open@ if the file meets certain requirements. A file is being watched if @hash_watcher[hash].file_pointer@ is equal to the file pointer referenced in the currently executing system call hook. If a hash slot is unused, its @file_pointer@ should be @NULL@.
